...
const FloatingUpdateButtons = ({
  ...
  return session ? (
    <div className="sticky bottom-6 z-10 mr-5 flex justify-end">
      <div className="flex items-center justify-center gap-4 rounded-xl bg-white p-4 shadow-[0_8px_15px_rgba(0,0,0,0.3)] md:bottom-8 md:right-7 md:gap-5 md:p-4">
        {game.ean !== null && session?.user?.role === 'admin' && (
          <GameUpdateButton
            game={game}
            operation="removeEAN"
            buttonType="detail"
