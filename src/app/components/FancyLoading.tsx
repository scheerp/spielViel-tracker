...
const messages = [
  ...
  'Die Startspieler*innen-Frage wird noch geklärt...',
  ...
  'Jemand hat den Startspieler*innenmarker verloren... Moment!',
  ...
  'Die Spieler*innen diskutieren noch über Hausregeln...',
...
const FancyLoading: React.FC = () => {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center overflow-hidden">
      <div className="-mt-80 h-52 max-w-64 md:max-w-80">
